...
nnoremap("<C-j>", "<C-d>", { silent = false })
nnoremap("<C-k>", "<C-u>", { silent = false })

nnoremap("<leader>e", ":NvimTreeToggle<cr>", { silent = false })
nnoremap("<leader>s", [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]], { silent = false })

nnoremap("<C-l>", ":bnext<CR>", { silent = false })
nnoremap("<C-h>", ":bprevious<CR>", { silent = false })
nnoremap("<C-c>", ":bwipeout<CR>", { silent = false })
